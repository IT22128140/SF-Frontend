...
  ];
  ...
  return (
    <div className='relative' style={{ backgroundImage: "/Picture1.jpg", backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <PMHeader />
      <h1 className='text-4xl my-4 font-BreeSerif' style={{ textAlign: 'center', color: 'brown' }}>Ridmi's Part</h1>
      {loading ? <Spinner /> : ''}
      
      <FormProvider {...methods}> 
        <form onSubmit={methods.handleSubmit(handleSaveProductList)} className="flex flex-col bg-bgc border-2 border-bgc rounded-xl w-[600px] p-8 mx-auto font-BreeSerif">
        <Input
            formtype='textarea'
            label='Product Code'
            id='productCode'
