...
const DeleteEmployee = ({ id, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-3xl ml-4 my-4 font-Philosopher text-ternary">Are You Sure You Want To Delete This Employee&rsquo;s Details?</h1>
        <MdOutlineCancel
        ...
        <div className="flex flex-col mb-6 items-start border-black rounded-xl w-[700px] p-6 mx-auto text-2xl font-BreeSerif">
            <div className="flex flex-row">This action <p style={{ color: 'red' }}>&nbsp;cannot be undone&nbsp;</p> once you click on the Delete. <br />
            </div> 
          ...
          {/* <button
            className="mt-12 p-4 bg-red-600 text-white w-90%"
