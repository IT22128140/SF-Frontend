    ...
    <div>
      ...
      <div className="p-4 h-screen overflow-y-auto">
        ...
        {loading ? (
          ...
          <>
            <div className="mb-4">
              <h3 className="text-sm font-semibold leading-relaxed absolute top-[200px] left-[400px] ">
                Easily handle payments on our safe online platform. Quick,
                simple, and secure transactions ensure a smooth digital
                experience, <br />
                making your financial interactions trouble-free and efficient.
              </h3>

              <label className="block text-ternary text-lg font-bold mb-2 absolute top-[290px] left-[500px] ">
                Total Payment
              </label>
