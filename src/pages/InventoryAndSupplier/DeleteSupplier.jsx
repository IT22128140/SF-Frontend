...
<<<<<<< HEAD
        <h1 className="my-8 text-5xl font-semibold font-philosopher text-ternary alignment-center">Delete Supplier </h1>
=======
        <h1 className="text-6xl my-9 font-Philosopher">Delete Supplier </h1>
