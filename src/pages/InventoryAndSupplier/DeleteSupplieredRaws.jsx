...
const handleDelete = () =>{
  ...
  return (
    <div className='p-4'>
        ...
        <h1 className="my-8 text-5xl font-semibold font-philosopher text-ternary alignment-center">Delete Supplied Raw material </h1>
      </div>
        {loading ? <Spinner /> : ''}
...
export default DeletesupDetails;