...
const DeleteButton = ({ onClick, className, children }) => {
  return (
    <button
      onClick={onClick}
      className={`flex items-center justify-between px-4 py-2 bg-red-600 text-white rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-blue-600 ${className}`}
    >
      <span>{children}</span> 
